...
const organizationSchema = { "@context": "https://schema.org", "@type": "TravelAgency", "@id": `${baseUrl}/#travel-agency`, name: "Only Road Trip", legalName: "Swastik Tour And Travels Private Limited", alternateName: "Only Road Trip", url: baseUrl, logo: `${baseUrl}${socialImage}`, image: `${baseUrl}${socialImage}`, description: "Travel agency offering pilgrimage tours, domestic holidays, luxury road trips, family vacations, heritage tours, adventure journeys and corporate travel across India.", email: "info@onlyroadtrip.com", telephone: "+91-9211796168", foundingDate: "2025-05-20", address: { "@type": "PostalAddress", streetAddress: "F163, PH-1, New Palam Vihar", addressLocality: "Gurugram", addressRegion: "Haryana", postalCode: "122001", addressCountry: "IN" }, areaServed: { "@type": "Country", name: "India" }, contactPoint: { "@type": "ContactPoint", telephone: "+91-9211796168", email: "info@onlyroadtrip.com", contactType: "Customer Support", availableLanguage: ["English", "Hindi"] }, serviceType: ["Domestic Travel", "Pilgrimage Tours", "Spiritual Travel", "Road Trips", "Adventure Travel", "Wildlife Travel", "Family Holidays", "Solo Travel", "Women Travel", "Senior Citizen Travel", "Accessible Travel", "Corporate Travel", "MICE Travel", "Customized Travel"] , knowsAbout: ["Travel Agency Services", "Travel Management", "Domestic Tourism", "Domestic Tour Packages", "Pilgrimage Tours", "Spiritual Tourism", "Road Trips", "Adventure Travel", "Wildlife Safaris", "Mountain Travel", "Beach Holidays", "Cultural and Heritage Travel", "Family Holidays", "Solo Travel", "Women Travel", "Senior Citizen Travel", "Accessible and Inclusive Travel", "Corporate Travel Management", "MICE Travel", "Customized Travel Planning"] };
...
export default function Home() {
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(organizationSchema) }} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(localBusinessSchema) }} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema) }} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(websiteSchema) }} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema) }} /><Hero /><Categories /><GroupToursSlider /><FeaturedDestinations /><WhyChooseUs /><Testimonials /><Stats /></>;
}
