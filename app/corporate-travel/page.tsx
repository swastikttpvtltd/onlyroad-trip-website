  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-20 pt-32 lg:px-8 lg:pb-28 lg:pt-40">
          <div className="grid items-center gap-14 lg:grid-cols-[1.1fr_.9fr]">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-4 py-2 text-xs font-bold uppercase tracking-[0.22em] text-blue-800">
              ...
              <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-600 md:text-xl">
                Managing business travel can take a lot of time, especially when employees are travelling to different cities, plans keep changing and several bookings have to be coordinated at the same time. At Only Road Trip, we take care of these travel arrangements so your team can focus on work.
              </p>

              <p className="mt-4 max-w-2xl text-base leading-7 text-slate-500">
                From flights and hotels to airport transfers, meetings, conferences, employee outings and corporate offsites, we can plan the complete travel requirement around your company&apos;s schedule and budget.
              </p>

              <div className="mt-9 flex flex-wrap gap-4">
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 rounded-full bg-blue-800 px-7 py-3.5 text-sm font-bold text-white shadow-lg shadow-blue-900/10 transition hover:bg-blue-900"
                >
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-7 py-3.5 text-sm font-bold text-slate-800 transition hover:border-blue-200 hover:bg-blue-50"
                >
                  Speak to Our Team
                </Link>
              </div>
            ...
            <div className="relative">
              <div className="rounded-[32px] border border-slate-200 bg-white p-5 shadow-[0_25px_70px_rgba(15,23,42,0.10)]">
                <div className="rounded-[24px] bg-slate-950 p-7 text-white md:p-9">
                  <p className="text-xs font-bold uppercase tracking-[0.22em] text-blue-300">Corporate Travel Desk</p>
                  <h2 className="mt-4 text-3xl font-semibold leading-tight">One team to coordinate your travel.</h2>
                  ...
                  <div className="mt-8 space-y-4">
                    {[
                      ...
                      return (
                        <div key={String(text)} className="flex items-center gap-4 border-t border-white/10 pt-4 first:border-t-0 first:pt-0">
      ...
      <section className="py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:items-start">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.24em] text-blue-700">Corporate Travel Management</p>
      ...
      <section className="border-y border-slate-100 bg-slate-50 py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-xs font-bold uppercase tracking-[0.24em] text-blue-700">What We Handle</p>
            <h2 className="mt-4 text-4xl font-semibold text-slate-950 md:text-5xl">Complete corporate travel support</h2>
            ...
            {services.map((service) => {
              ...
              return (
                <div key={service.title} className="group rounded-3xl border border-slate-200 bg-white p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl hover:shadow-slate-200/50">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 text-blue-800 transition group-hover:bg-blue-800 group-hover:text-white">
                    <Icon size={23} />
                  </div>
      ...
      <section className="py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.24em] text-blue-700">MICE & Corporate Offsites</p>
              <h2 className="mt-4 text-4xl font-semibold leading-tight text-slate-950 md:text-5xl">
                From business meetings to team getaways.
              </h2>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ["Executive Travel", "Comfortable and well-planned arrangements for senior management and business travellers."],
                ["Employee Offsites", "Hotels, transport and activities planned around your team size and programme."],
                ["Dealer & Incentive Trips", "Travel programmes that combine business requirements with a good experience for participants."],
                ["Meetings & Conferences", "Coordinated accommodation, transfers and local movements for business events."],
              ].map(([title, text]) => (
      ...
      <section className="bg-slate-950 py-20 text-white lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-14 lg:grid-cols-[.85fr_1.15fr] lg:items-center">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.24em] text-blue-300">Why Only Road Trip</p>
              <h2 className="mt-4 text-4xl font-semibold leading-tight md:text-5xl">A travel partner your team can actually rely on.</h2>
      ...
      <section className="py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <p className="text-xs font-bold uppercase tracking-[0.24em] text-blue-700">How It Works</p>
            <h2 className="mt-4 text-4xl font-semibold text-slate-950 md:text-5xl">Simple from the first conversation.</h2>
          </div>
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-3">
            {[
              ...
              ["02", "We plan the travel", "Our team works through the flights, hotels, transport and other requirements and puts together suitable options."],
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="overflow-hidden rounded-[32px] bg-blue-800 px-7 py-12 text-white md:px-12 md:py-14 lg:px-16">
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div className="max-w-3xl">
                <p className="text-xs font-bold uppercase tracking-[0.24em] text-blue-200">Let&apos;s Plan Your Next Trip</p>
                <h2 className="mt-4 text-4xl font-semibold leading-tight md:text-5xl">Have a corporate travel requirement?</h2>
              ...
              <Link href="/contact" className="inline-flex w-fit items-center gap-2 rounded-full bg-white px-7 py-3.5 text-sm font-bold text-blue-900 transition hover:bg-blue-50">
