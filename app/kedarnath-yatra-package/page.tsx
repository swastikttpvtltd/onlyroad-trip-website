...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Kedarnath Yatra Package from Delhi | Only Road Trip", description: "Customized Kedarnath Yatra packages with transport, stays and practical route planning.", url: `${baseUrl}/kedarnath-yatra-package`, siteName: "Only Road Trip", locale: "en_IN", type: "website", images: [{ url: "/images/logo/only-road-trip-logo.jpeg", alt: "Only Road Trip Kedarnath Yatra" }] },
...
const schema = { "@context": "https://schema.org", "@graph": [
  { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: baseUrl }, { "@type": "ListItem", position: 2, name: "Kedarnath Yatra Package", item: `${baseUrl}/kedarnath-yatra-package` }] },
...
export default function KedarnathYatraPackagePage() {
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} /><NicheLandingPage variant="kedarnath" /><RelatedPilgrimageLinks current="kedarnath" /></>;
}
