...
const regionData: Record<string, { name: string; title: string; intro: string; why: string; experiences: string[]; coming: string }> = {
  ...
  "himachal-pradesh": { name: "Himachal Pradesh", title: "Life Inside a Himalayan Village", intro: "Slow down in real Himalayan communities and understand traditional homes, farming, forests, food, local occupations and mountain life.", why: "Himachal's villages are shaped by terrain, seasons, agriculture, forests and close community networks. The itinerary should follow that natural rhythm.", experiences: ["Traditional village architecture and history", "Terrace farming and seasonal crops", "Local water sources and irrigation", "Regional Himachali home cooking", "Apple, orchard or local agriculture experiences where relevant", "Local crafts and occupations", "Mountain walks and village storytelling", "Verified homestay with local host"], coming: "Village routes will be selected by district and season after local verification." },
};
