...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Only Road Trip Gurugram",
    "Swastik Tour And Travels Private Limited",
    "travel company in Gurugram",
  ...
  openGraph: {
    title: "About Only Road Trip | Travel Company in Gurugram",
    description:
      "Discover Only Road Trip and our approach to pilgrimage tours, domestic holidays, road trips and corporate travel across India.",
    url: `${baseUrl}/about`,
    siteName: "Only Road Trip",
    locale: "en_IN",
    type: "website",
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "About Only Road Trip" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "About Only Road Trip",
    description: "Travel experiences and customized journeys across India.",
    images: ["/og-image.jpg"],
  },
