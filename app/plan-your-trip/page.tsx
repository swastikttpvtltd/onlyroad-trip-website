      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.1fr_.9fr] lg:py-20">
        <div className="rounded-[2rem] border border-slate-200 bg-white p-7 shadow-[0_20px_60px_rgba(15,23,42,0.10)] sm:p-10">
          ...
          <form className="mt-8 grid gap-5 sm:grid-cols-2">
            ...
            <input placeholder="Destination" className="rounded-xl border border-slate-300 bg-slate-50 px-4 py-3.5 outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-100" />
            <div className="relative"><CalendarDays className="absolute left-4 top-4 text-blue-600" size={19}/><input type="text" placeholder="Travel Dates" className="w-full rounded-xl border border-slate-300 bg-slate-50 py-3.5 pl-11 pr-4 outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-100" /></div>
            <div className="relative"><Users className="absolute left-4 top-4 text-blue-600" size={19}/><input type="text" placeholder="Number of Travellers" className="w-full rounded-xl border border-slate-300 bg-slate-50 py-3.5 pl-11 pr-4 outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-100" /></div>
