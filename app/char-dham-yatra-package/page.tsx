...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Char Dham Yatra Package from Delhi | Only Road Trip",
    description: "Customized Char Dham Yatra packages with transport, stays and travel coordination.",
    url: `${baseUrl}/char-dham-yatra-package`,
    siteName: "Only Road Trip",
    locale: "en_IN",
    type: "website",
    images: [{ url: "/images/logo/only-road-trip-logo.jpeg", alt: "Only Road Trip Char Dham Yatra" }],
  },
...
const schema = {
  ...
  "@graph": [
    { "@type": "BreadcrumbList", itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Char Dham Yatra Package", item: `${baseUrl}/char-dham-yatra-package` },
    ] },
...
export default function CharDhamYatraPackagePage() {
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} /><NicheLandingPage variant="char-dham" /></>;
}
