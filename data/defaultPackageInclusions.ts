export const defaultPackageInclusions = [
  ...
  "Services of the Tour Manager from the first day of meeting point to the last day dropping point of the tour. (Except for Uttaranchal Chardham Yatra).",
  "Cost of any internal airfare if specified in the itinerary.",
  "Driver Tips and Guide Tips as per the itinerary.",
  "City Tax (if applicable) as per the itinerary.",
];
