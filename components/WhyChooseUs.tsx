    ...
    <section className="bg-slate-50 py-10 md:py-12">
      <div className="mx-auto max-w-7xl px-5">
        <div className="mb-7 text-center">
          <span className="rounded-full bg-blue-100 px-3.5 py-1 text-[11px] font-bold uppercase tracking-[0.18em] text-blue-800">Why Only Road Trip</span>
          <h2 className="mt-3 text-3xl font-extrabold tracking-tight text-slate-900 md:text-4xl">Experience Travel The Premium Way</h2>
          <p className="mx-auto mt-2 max-w-3xl text-sm leading-6 text-slate-600 md:text-base">We don&apos;t just plan trips. We create unforgettable experiences with premium service, carefully designed itineraries and complete travel assistance.</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {features.map((item, index) => {
            ...
            return (
              <div key={index} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_8px_25px_rgba(15,23,42,0.05)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_14px_35px_rgba(15,23,42,0.10)]">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-800 text-white"><Icon size={24} /></div>
