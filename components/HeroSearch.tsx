...
export default function HeroSearch(){
 ...
 return <div className="relative overflow-visible rounded-[28px] border border-white/40 bg-white/15 p-3.5 font-semibold backdrop-blur-3xl shadow-[0_16px_55px_rgba(15,23,42,0.30)]">
  ...
  <div className="relative z-10 grid grid-cols-1 gap-3.5 lg:grid-cols-4">
   <div className="relative rounded-2xl border border-white/50 bg-white/95 p-3.5 backdrop-blur-xl transition-all duration-300 hover:border-blue-300 hover:bg-white hover:shadow-lg">
    <div className="mb-2 flex items-center gap-2"><MapPin className="h-5 w-5 font-bold text-blue-800" strokeWidth={2.5}/><span className="text-xs font-extrabold uppercase tracking-widest text-slate-800">Destination</span></div>
   ...
   <div className="rounded-2xl border border-white/50 bg-white/95 p-3.5 backdrop-blur-xl transition-all duration-300 hover:border-blue-300 hover:bg-white hover:shadow-lg">
    <div className="mb-2 flex items-center gap-2"><Calendar className="h-5 w-5 font-bold text-blue-800" strokeWidth={2.5}/><span className="text-xs font-extrabold uppercase tracking-widest text-slate-800">Travel Date</span></div>
   ...
   <div className="rounded-2xl border border-white/50 bg-white/95 p-3.5 backdrop-blur-xl transition-all duration-300 hover:border-blue-300 hover:bg-white hover:shadow-lg">
    <div className="mb-2 flex items-center gap-2"><Users className="h-5 w-5 font-bold text-blue-800" strokeWidth={2.5}/><span className="text-xs font-extrabold uppercase tracking-widest text-slate-800">Travellers</span></div>
    <div className="flex items-center justify-between"><button type="button" onClick={()=>setTravellers(p=>Math.max(1,p-1))} className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-slate-50 text-xl font-extrabold leading-none text-slate-900 shadow-sm">−</button><span className="text-2xl font-extrabold text-slate-900">{travellers}</span><button type="button" onClick={()=>setTravellers(p=>p+1)} className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-slate-50 text-xl font-extrabold leading-none text-slate-900 shadow-sm">+</button></div>
   </div>
   <button type="button" onClick={handleSearch} className="group flex items-center justify-center gap-3 rounded-2xl border border-blue-700 bg-blue-800 px-6 py-3.5 text-lg font-extrabold text-white shadow-[0_12px_32px_rgba(30,64,175,0.30)] transition-all duration-300 hover:-translate-y-1 hover:scale-[1.01] hover:bg-blue-900"><Search className="h-5 w-5" strokeWidth={2.5}/>Search Tours</button>
  </div>
 </div>;
}
