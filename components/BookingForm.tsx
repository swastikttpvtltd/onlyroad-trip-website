...
async function submit(e:React.FormEvent){
  ...
  try {
    ...
    if(data.payment_session_id){
      ...
      alert("Booking request submitted! Our team will send you the Cashfree payment link shortly.");
    }
  } catch (err) {
    console.error(err);
    alert("Unable to initiate online payment directly. Our team will contact you to proceed.");
  }
}
