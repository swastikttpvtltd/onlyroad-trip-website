...
export default function PackageCard({ pkg }: Props) {
  ...
  const displayPrice = getGroupTourStartingPrice(pkg);
  const isGroup = displayPrice !== Number(pkg.price ?? 0);
