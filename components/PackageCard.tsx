  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-[20px] border border-slate-200 bg-white shadow-[0_8px_28px_rgba(15,23,42,0.07)] transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-[0_16px_38px_rgba(15,23,42,0.12)]">
      ...
      <div className="flex flex-1 flex-col px-4 py-4">
        ...
        <div className="mt-4 border-t border-slate-100 pt-3"><p className="mb-2 text-sm font-semibold text-slate-800">Tour Includes</p><div className="flex items-center gap-4 text-blue-700"><span title={t("accommodation")} aria-label={t("accommodation")} className="text-base">▰</span>{hasMeals && <Utensils className="h-4 w-4" aria-label={t("mealsIncluded")} />}{hasSightseeing && <Camera className="h-4 w-4" aria-label={t("sightseeingIncluded")} />}{hasTransport && <Bus className="h-4 w-4" aria-label={t("transportIncluded")} />}</div></div>
