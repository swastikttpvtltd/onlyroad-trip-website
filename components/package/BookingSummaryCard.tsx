...
type Props = {
  pkg?: { slug?: string; title?: string; duration?: string; destination?: string; state?: string; category?: string; themes?: string[]; packageId?: string; sharingRates?: SharingRate[]; groupRates?: { sharingRates?: SharingRate[] }; price?: number; itinerary?: ItineraryDay[]; inclusions?: string[]; exclusions?: string[]; termsAndConditions?: string[]; terms?: string[] };
